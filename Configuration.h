...
#define STRING_CONFIG_H_AUTHOR "(JOGIAREA, E5 RFF V1.1.)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "E5 JH V220214.5"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.7, 79.8, 800, 139.9 }
...
#define DEFAULT_TRAVEL_ACCELERATION   1225    // X, Y, Z acceleration for travel (non printing) moves
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -15, -1.440 }
